...
class CvForm extends React.Component {
  ...
  render() {
    return (
      ...
      >
      <input name='Aplikacja' id='praca' className='subtitle' placeholder='Złóż aplikację:' disabled style={{color:'gray',fontFamily:'Poppins', backgroundColor:'white',border:'0px solid white',marginBottom:'20px'}} />
      <br />
